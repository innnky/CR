    ...
    <div class="row  align-items-center" style="height: 100%;">
      <div class="col-12 bg-white py-2 mb-0" style="height: 90%">
        ...
        <div class="row px-4 py-3">
          <div class="col-12">
            <span class="mx-2">班主任</span>
            <el-tag size="mini" type="primary">{{headMaster.teacherName}}</el-tag>
            <span class="mx-2">联系方式</span>
            <el-tag size="mini" type="primary">{{headMaster.contact}}</el-tag>
          </div>
          <el-table
              :data="tableData"
              stripe
...
export default {
  ...
  methods: {
    initData(){
      getRequest("/student/class/").then(res=>{
        this.tableData = res;
      })
      getRequest("/student/class/headMaster").then(res=>{
        this.headMaster = res;
      })
    },
