<template>
  <div class="container">
    ...
    <div class="row" style="box-shadow: #e7e7e7 0px 0px 10px 1px;min-height:650px;">
      <div class="col bg-white pb-4">
        ...
        <div class="row g-4 px-3 mt-0">
          ...
          box-shadow: #e0e0e0 0px 0px 10px 1px" @click="showCourseDetail(i)">
