  ...
  <div class="row px-3">
    <div class="col-3">
      <el-form-item label="姓名">
        <el-input placeholder="请输入姓名" class="w-75" v-model="conditions.studentName"></el-input>
      </el-form-item>
    </div>
    <div class="col-3">
      <el-form-item label="学生id">
        <el-input placeholder="请输入学号" class="w-75" v-model="conditions.studentId"></el-input>
      </el-form-item>
    </div>
    <div class="col-3">
    ...
    <el-form :model="inputData">
      <div class="container">
        <div class="row">
          ...
          <div class="col-4">
            <el-form-item label="学生id">
              <el-input placeholder="请输入学号" class="w-75" v-model="inputData.studentId"></el-input>
            </el-form-item>
          </div>
          <div class="col-4">
...
export default {
  ...
  methods: {
    initTableData() {
      getRequest("/admin/account/student/", {
