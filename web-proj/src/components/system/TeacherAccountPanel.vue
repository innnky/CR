    ...
    <div class="row px-3">
      <div class="col-3">
        <el-form-item label="姓名">
          <el-input placeholder="请输入姓名" class="w-75" v-model="conditions.teacherName"></el-input>
        </el-form-item>
      </div>
      <div class="col-3">
        <el-form-item label="教师id">
          <el-input placeholder="请输入教师id" class="w-75" v-model="conditions.teacherId"></el-input>
        </el-form-item>
      </div>
      <div class="col-3">
    ...
    <el-form :model="inputData">
      <div class="container">
        <div class="row">
          ...
          <div class="col-4">
            <el-form-item label="教师id">
              <el-input placeholder="请输入学号" class="w-75" v-model="inputData.teacherId"></el-input>
            </el-form-item>
          </div>
          <div class="col-4">
